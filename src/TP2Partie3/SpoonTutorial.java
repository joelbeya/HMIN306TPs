...
public class SpoonTutorial<T>
{
    ...
    {
        String packagePath = "/home/bj/eclipse-hmin306/hmin306TPs/src";
        String personFile = packagePath + "/home/bj/eclipse-hmin306/hmin306TPs/src/TP2Partie3/Person.java";
        String mainFile = packagePath + "/home/bj/eclipse-hmin306/hmin306TPs/src/TP2Partie3/Main.java";
        ...
        spoonInstance.saveRefactoredFiles(personFile, "TP2Partie3.refactor", personClass);
        spoonInstance.saveRefactoredFiles(mainFile, "TP2Partie3.refactor", mainClass);
    }
